            ...
            <div className="flex flex-col gap-2">
              <a href="/mis-trabajos" onClick={() => setMostrarMisCosas(false)}
                ...
                <div className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0" style={{background: '#F5F0FF'}}>
                  <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={MORADO} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 7V5a2 2 0 00-2-2h-4a2 2 0 00-2 2v2"/></svg>
                </div>
                <div className="flex-1 min-w-0">
                  <p className="font-extrabold text-gray-900 text-sm">Mis trabajos</p>
                  <p className="text-gray-400 text-xs">Trabajos a los que aplicaste</p>
                </div>
              ...
              <a href="/aplicaciones" onClick={() => setMostrarMisCosas(false)}
                className="flex items-center gap-4 p-4 bg-gray-50 border-2 border-gray-100 rounded-2xl hover:border-purple-200 transition">
                <div className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0" style={{background: '#F5F0FF'}}>
                  <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={MORADO} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><path d="M14 2v6h6M16 13H8M16 17H8M10 9H8"/></svg>
                </div>
                <div className="flex-1 min-w-0">
                  <p className="font-extrabold text-gray-900 text-sm">Mis solicitudes</p>
                  <p className="text-gray-400 text-xs">Solicitudes que publicaste</p>
                </div>
                <span className="text-gray-400 flex-shrink-0">→</span>
              </a>
            </div>
