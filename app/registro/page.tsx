      ...
      <div className="max-w-md w-full">
          ...
          <div>
            ...
            <div className="flex flex-col gap-4">
              <div>
                ...
                <input type="text" placeholder="Ej. María López" value={nombre} onChange={(e) => setNombre(e.target.value)}
        ...
        {paso === 3 && (
          <div className="text-center">
            ...
            <button onClick={() => setPaso(2)} className="mt-4 text-gray-400 text-sm hover:text-gray-600 block mx-auto">
              ← Regresar
            </button>
          </div>
        )}
