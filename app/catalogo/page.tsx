...
const catalogoIconos: Record<string, React.ReactElement> = {
  '🧹 Limpieza del hogar': <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#7B2FE0" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M15 3l-9.5 9.5"/><path d="M5.5 12.5L3 21l8.5-2.5"/><path d="M15 3l6 6-3.5 3.5"/><path d="M3 21l4-4"/></svg>,
  ...
  '🎨 Pintura': <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#7B2FE0" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M18.37 2.63L14 7l-1.59-1.59a2 2 0 00-2.82 0L8 7l9 9 1.59-1.59a2 2 0 000-2.82L17 10l4.37-4.37a2.12 2.12 0 00-3-3z"/><path d="M9 8c-2 3-4 3.5-7 4l8 8c1-.5 3.5-2 4-7"/><path d="M14.5 17.5L4.5 15"/></svg>,
  ...
  '🚿 Plomería': <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#7B2FE0" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4"/></svg>,
  ...
  '🔩 Mecánica básica': <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#7B2FE0" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 00.33 1.82l.06.06a2 2 0 010 2.83 2 2 0 01-2.83 0l-.06-.06a1.65 1.65 0 00-1.82-.33 1.65 1.65 0 00-1 1.51V21a2 2 0 01-4 0v-.09A1.65 1.65 0 009 19.4a1.65 1.65 0 00-1.82.33l-.06.06a2 2 0 01-2.83-2.83l.06-.06A1.65 1.65 0 004.68 15a1.65 1.65 0 00-1.51-1H3a2 2 0 010-4h.09A1.65 1.65 0 004.6 9a1.65 1.65 0 00-.33-1.82l-.06-.06a2 2 0 012.83-2.83l.06.06A1.65 1.65 0 009 4.68a1.65 1.65 0 001-1.51V3a2 2 0 014 0v.09a1.65 1.65 0 001 1.51 1.65 1.65 0 001.82-.33l.06-.06a2 2 0 012.83 2.83l-.06.06A1.65 1.65 0 0019.4 9a1.65 1.65 0 001.51 1H21a2 2 0 010 4h-.09a1.65 1.65 0 00-1.51 1z"/></svg>,
  ...
  '🪵 Carpintería ligera': <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#7B2FE0" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M2 18l4-4 4 4 4-4 4 4"/><path d="M2 6l4 4 4-4 4 4 4-4"/></svg>,
  '📦 Mudanza ligera / Ayudante': <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#7B2FE0" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M3 3h18v18H3z" rx="2"/><path d="M3 9h18"/><path d="M9 21V9"/></svg>,
  '👔 Planchado / Lavandería': <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#7B2FE0" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M4 21h16"/><path d="M6 21V8a6 6 0 0112 0v1h-4a2 2 0 000 4h4v8"/><path d="M6 13h6"/></svg>,
  ...
  '🍽️ Mesero': <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#7B2FE0" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M3 16h18"/><path d="M12 3v5"/><path d="M5 8a7 7 0 0014 0"/><circle cx="12" cy="20" r="1"/></svg>,
  ...
  '🚗 Chofer ejecutivo': <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#7B2FE0" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M5 17H3a2 2 0 01-2-2v-5l3.5-6h13L22 10v5a2 2 0 01-2 2h-2"/><circle cx="7.5" cy="17.5" r="2.5"/><circle cx="16.5" cy="17.5" r="2.5"/><path d="M1 10h22"/></svg>,
