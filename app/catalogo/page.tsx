      ...
      <div className="max-w-md mx-auto px-6 mt-5">
        ...
        {fleksersFiltrados.length === 0 ? (
          <div className="bg-white rounded-2xl p-8 text-center shadow-sm border border-gray-100">
            ...
            {hayFiltros && (
              <button onClick={limpiarFiltros}
                className="mt-4 px-6 py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-2xl font-bold text-sm">
                Limpiar filtros
              </button>
            )}
          </div>
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-end" onClick={() => setMostrarFiltros(false)}>
          <div className="w-full bg-white rounded-t-3xl p-6 pb-10 max-h-[85vh] overflow-y-auto"
            ...
            <div className="flex items-center justify-between mb-5">
              ...
              {hayFiltros && (
                <button onClick={limpiarFiltros} className="text-sm text-purple-600 font-bold">Limpiar todo</button>
              )}
            </div>
